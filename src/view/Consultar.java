...
import com.model.daoimpl.ProdutoDAOImpl;
import com.model.daoimpl.ClienteDAOImpl;
import com.model.daoimpl.MesaDAOImpl;
...
public class Consultar extends javax.swing.JFrame {
    ...
    public Consultar() {
        ...
        MesaDAO mdao = new MesaDAOImpl();
        for(Mesa m: mdao.findALL(new Mesa())){
...
//        Integer.parseInt(mesaComboBox.getSelectedItem().toString()))
        for (Cliente c : cdao.Findmesa(1) ){
